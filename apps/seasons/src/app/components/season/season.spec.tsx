...
describe('Season', () => {
  ...
  it('should render summer season in south latitude on November', () => {
    const { getByText } = render(
      <Season lat={southLatitude} month={months[10]} />
    );
  ...
  it('should render winter season in south latitude on April', () => {
    const { getByText } = render(
      <Season lat={southLatitude} month={months[3]} />
    );
  ...
  it('should render summer season in north latitude on April', () => {
    const { getByText } = render(
      <Season lat={northLatitude} month={months[3]} />
    );
  ...
  it('should render winter season in north latitude on November', () => {
    const { getByText } = render(
      <Season lat={northLatitude} month={months[10]} />
    );
  ...
  it('should render sun icons for summer', () => {
    ...
    expect(
      queryByTestId(`${messageBySeason[SeasonName.summer].iconName}-left`)
    ).toBeDefined();
    expect(
      queryByTestId(`${messageBySeason[SeasonName.summer].iconName}-right`)
    ).toBeDefined();
  });
  ...
  it('should render snowflake icons for winter', () => {
    ...
    expect(
      queryByTestId(`${messageBySeason[SeasonName.winter].iconName}-left`)
    ).toBeDefined();
    expect(
      queryByTestId(`${messageBySeason[SeasonName.winter].iconName}-right`)
    ).toBeDefined();
  });
});
